...
export const registerUser = async (req, res) => {
  ...
  // Hash the Otp
  const ttl = 1000 * 60 * 5; //time to live 2 min
  ...
  try {
    ...
    let mailOptions = {
      ...
      <br>
      <p><b>This OTP is valid for 2 minutes only.</b></p>
...
export const verifyOtpEmail = async (req, res) => {
  ...
  const computedHash = hashOtp(data); //Whether Hashed otp is correct or not
