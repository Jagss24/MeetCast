...
import { RoomConatiner, Title, About, UserContainers, EachSpeaker, ButtonConatiners, Spinner, LoadingContainer, SpeakerContainer, AllowContainer, DeclinedText } from './Room.styled'
                ...
                {!roomType && (
                    <>
                        ...
                        <UserContainers>
                            ...
                            {user?.id === room?.ownerId?._id && < AllowContainer >
                                <h3>Waiting List</h3>
                                <div>
                        ...
                        {userisInRemovedList && <DeclinedText>User has declined your request</DeclinedText>}

                        <ButtonConatiners>
                            {room?.accessibility === "public" || user?.id === room?.ownerId?._id ?
                                ...
                                : <button disabled={isLoading || !roomId || !user?.id || isSuccess || userisAlreadyinWaitingList}
                                    ...
                                    {isSuccess || userisAlreadyinWaitingList ? "Already requested" : userisInRemovedList ? "Request Again" : userisInMemberList ? "Join the Room" : "Request to Join the room"}
