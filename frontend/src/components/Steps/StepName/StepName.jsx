    ...
    <>
      <MainStyled>
        <CardStyled>
          ...
          <InputStyled placeholder="Enter your FullName" value={data.fullName} name="fullName" onChange={handleChange}></InputStyled>
          <InputStyled placeholder="Set your username" value={data.name} name="name" onChange={handleChange}></InputStyled>
