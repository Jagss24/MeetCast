      ...
      <StartRoomBody>
        <StartRoomHeader>
          ...
          <RoomTypes>
            <div>
              <RoomType
                roomType={activeRoom === 'podcast'}
                onClick={() => setActiveRoom(roomType[0])}>
                <FaPodcast />
            ...
            <div>
              <RoomType
                roomType={activeRoom === 'meet'}
                onClick={() => setActiveRoom(roomType[1])}>
                <MdVideoCall size={20} />
            ...
            {activeRoom === 'podcast' && (
              <TopicDiv>
                ...
                <Select
                  ...
                  value={
                    openTopicOptions.label && openTopicOptions.value
                      ? openTopicOptions
                      : null
                  }
